...
public class Main {
    public static void main(String[] args) {
       ...
       System.out.println(HomeworkEleven.numToSortedString(new String[]{"1, 2, 0", "4, 5"}));

       HomeworkEleven.randomNumsGenerator(25214903917L, 11L, 2^48L).limit(20).forEach(System.out::println);

       Stream<String> res = HomeworkEleven.zip(Stream.of("sf", "sdf", "sada"), Stream.of("rtre", "ytu", "utrr", "kirby"));
